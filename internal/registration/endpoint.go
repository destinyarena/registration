...
func (h *handler) endpoint(c echo.Context) error {
	...
	if alt {
		err = errors.New("Sorry but an account with this information already exists or your account has been banned, please contact and admin if this is a mistake.")
		h.Logger.Error(err)
